...
class KKDataLoader(Data.Dataset):
    ...
    def get_batch(self, split, batch_size=None, seq_per_img=None):
        ...
        datas = {}
        datas['fc_feats'] = np.stack(fc_batch)
        datas['att_feats'] = np.stack(att_batch)
        datas['labels'] = label_batch
        datas['gts'] = gts
        datas['masks'] = mask_batch
        datas['bounds'] = {'it_pos_now': self.iterators[split], 'it_max': len(self.split_ix[split]), 'wrapped': wrapped}
        datas['infos'] = infos
